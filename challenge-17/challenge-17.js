(function () {
  ...
  */
  ...
  console.log(text.replace(/Manuel Marques de Sousa/g,'João Pé de Feijão'));
  ...
  */
  ...
  console.log(
    text.replace(/O Centauro de Luvas/g, function (item) {
  ...
  */
  ...
  function getMonthNumber(monthName) {
    ...
    var monthNumber = '0' + (arrMonth.indexOf(monthName) + 1);
    monthNumber = monthNumber.length > 2 ? monthNumber.substring(1,3) : monthNumber;
    return monthNumber;
    */
    var months = {
      'janeiro' : '01',
