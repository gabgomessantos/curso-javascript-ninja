(function () {
  ...
  */
  var fullName = 'joão-pé-de-feijão';
  ...
  */
  var arrNames = ['João', 'Maria', 'Roberto', 'Pedro', 'Marcos'];
  var phrase = arrNames.reduce(function (acumulado, atual, index) {
    var separator = arrNames.length - 1 == index ? ' e ' : ', ';
